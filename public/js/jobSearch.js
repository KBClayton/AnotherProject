...
$("#submit-jobSearchGov").on("click", function(){
  ...
  $("#submit-jobSearchAJ").on("click", function(){
    ...
    if (
      ...
      //console.log(NewJob);
      var queryAuthJobsURL = ("https://authenticjobs.com/api/?api_key="/*KEYKEYKEYKEYKEYKEYKEYKEYKEY*/ +"&method=aj.jobs.search&category=" + searchKeywordAJ + "&perpage=5&location=" + searchLocationAJ + "&format=json")
      console.log("query: " + queryAuthJobsURL)
      $.ajax({
          url:queryAuthJobsURL,
          method:"GET",
